  ...
  <div id="header" class="container_12">
    <div class="grid_12">
      ...
      <div id="cart_menu" class="s_nav">
        <a href="cart.jsp"><span class="s_icon"></span> <small class="s_text">Cart</small><span class="s_grand_total s_main_color">1,034.00 eur</span></a>
      ...
      <form id="cart" class="clearfix" action="checkout.html">
        <table class="s_table_1" width="100%" cellpadding="0" cellspacing="0" border="0">
          ...
          <tr class="even">
            ...
            <td valign="middle"><a href="product1.jsp"><img src="images/dummy/pic_1.jpg" width="60" height="60" alt="Panasonic Lumix" /></a></td>
            <td valign="middle"><a href="product1.jsp"><strong>Panasonic Lumix</strong></a></td>
          ...
          <tr class="odd">
            <td valign="middle"><input type="checkbox" /></td>
            <td valign="middle"><a href="product1.jsp"><img src="images/dummy/pic_2.jpg" width="60" height="60" alt="Armani Acqua di Gioia" /></a></td>
            <td valign="middle"><a href="product1.jsp"><strong>Armani Acqua di Gioia</strong></a></td>
            <td valign="middle">Product 4</td>
            <td valign="middle"><input type="text" size="3" /></td>
          ...
          <tr class="even">
            <td valign="middle"><input type="checkbox" /></td>
            <td valign="middle"><a href="product1.jsp"><img src="images/dummy/pic_3.jpg" width="60" height="60" alt="Jameson Whiskey Special Reserve 12 yers" /></a></td>
            <td valign="middle"><a href="product1.jsp"><strong>Jameson Whiskey Special Reserve 12 yers</strong></a></td>
